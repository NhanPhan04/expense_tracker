...
const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
  ...
  return (
   <div className="flex flex-col items-center max-w-md mx-auto mt-10">
    <h2 className="mb-4 text-xl font-bold text-center">User Profile</h2>
    <img
      src={avatarFile ? URL.createObjectURL(avatarFile) : profile.avatar || DEFAULT_AVATAR}
      alt="Avatar"
    ...
    />
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="py-2 mt-2 text-white bg-blue-500"
        >
